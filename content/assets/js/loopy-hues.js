...
function iterate_hue() {
	...
	for(let i=0, t=0; t<360; ++i, t+=30)
		root_item.style.setProperty("--rnbw-color-" + i, hsl_rainbow((current_hue+t)%360));

	@/*root_item.style.setProperty("--rnbw-grad-top"   , "linear-gradient(to right, var(--rnbw-color-0), var(--rnbw-color-3)");
	root_item.style.setProperty("--rnbw-grad-right" , "linear-gradient(to bottom, var(--rnbw-color-3), var(--rnbw-color-6)");
	root_item.style.setProperty("--rnbw-grad-bottom", "linear-gradient(to left, var(--rnbw-color-6), var(--rnbw-color-9)");
	root_item.style.setProperty("--rnbw-grad-left"  , "linear-gradient(to top, var(--rnbw-color-9), var(--rnbw-color-0)");*/
